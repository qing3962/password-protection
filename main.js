...
var en_default = {
  ...
  notice_set_password: "Please set the password in the settings menu for the Password Protection Plugin first!",
  setting_folder_name: "Protected Folder",
  setting_folder_desc: "With relative paths, the '/' is the root path of vault folder",
  ...
  hint_password_valid_character: "Password has valid characters.",
  ...
  auto_lock_interval_desc: "The number of minutes to wait before auto-locking, since the file was opened.",
  forbid_close_verify_modal_name: "Disable closing the password verify box if the password isn't right",
  ...
  before_open_protection: "Turn on the switch below to enable password protection."
};
